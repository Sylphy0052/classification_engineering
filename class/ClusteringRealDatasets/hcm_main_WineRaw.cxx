...
int main(void){
  std::string filenameData("WineRaw.dat");
#ifdef CHECK_ANSWER
  std::string filenameCorrectCrispMembership("Wine.correctCrispMembership");
#endif
  ...
  std::ofstream outputfile("result3.txt", std::ios::app);
